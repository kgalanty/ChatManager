...
class Stats extends API
{
    public function get()
    {
        ...
        $threads = StatsHelper::getStats( ['datefrom' => $dateFrom, 'dateto' => $dateTo]);
        ...
        $threads_upgrade_points = StatsHelper::getDecrementPoints( ['datefrom' => $dateFrom, 'dateto' => $dateTo]);
        $o = StatsHelper::CreateResult($threads, $threads_upgrade_points);
        return ['data' => $o];
    }
